...
function App() {
  ...
  const menus = [
    ...
    {title:"Order Sacan (Pallet Replace)",path:'/order-scan' ,},
  ...
  return (
    <BrowserRouter>
      <div className="App">
        <MenuHeader companyName={'WMS'} client={'Samyang'} warehouse={'Samyang Fontana'} menus={menus}/>
        <Routes>
          <Route path='/' element={<MenuList menus={menus}/>}/>
          <Route path='/login' element={<Login />}/>
          <Route path='/move-location' element={<MoveLocation />}/>
